          ...
          <div className="flex justify-between">
            <div className="w-[60%] flex flex-col">
              ...
              <p>
                ...
                Mereka menawarkan tempat peristirahatan dari
                kehidupan sehari - hari dan terkesan dengan
                arsitektur modern dan perabotan bergaya. Biarkan
                diri Anda dimanjakan oleh tim kami yang penuh
                perhatian yang akan dengan senang hati mengurus
                setiap kebutuhan.
              </p>
            </div>
            <div className="w-[30%]">
