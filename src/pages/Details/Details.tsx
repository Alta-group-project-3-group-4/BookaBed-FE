        ...
        <div className="flex-1 p-6">
          ...
          <div className="flex justify-end mt-20">
            <div className="flex flex-col">
              <p className="flex justify-center font-semibold text-2xl text-black">Details Reservasi</p>
              <div className="card w-96 bg-white shadow-xl">
                <div className="card-body">
                  ...
                  <div className="flex flex-row">
                    ...
                    <p className="text-black">Rp 17.999.999</p>
                  </div>
                  <div className="flex flex-row">
                    <p className="text-black">Total</p>
                    <p className="text-black">Rp 21.999.999</p>
                  </div>
                </div>
              </div>
            </div>
          </div>
          <div className="flex flex-col items-center justify-center w-full h-full p-7 -mt-48">
            <div className="flex flex-col w-full">
              <img src={images} alt="" className="w-5/12" />
            </div>
          </div>
          <div className="flex flex-row p-7 space-x-7">
